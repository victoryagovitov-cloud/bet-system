...
Таргет канала: **до ~7 VALUE за прогон** (лучшие по edge после фильтров). Частоту регулируем whitelist’ом, спектром рынков и гигиеной value:
...
- не больше `MAX_VALUE_SIGNALS_PER_RUN` (по умолчанию 7) value за прогон — берём лучшие по edge;
